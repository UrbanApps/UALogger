...
Installation is made simple with [Cocoapods](http://cocoapods.org/)  (coming soon, [pull request](https://github.com/CocoaPods/Specs/pull/3866) pending). If you want to do it the old fashioned way, just add `UALogger.h` and `UALogger.m` to your project.
